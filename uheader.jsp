					...
					<div class="nav_w3ls">
						<nav>
							...
							<ul class="menu">
								...
								<li class="mx-lg-4 mx-md-3 my-md-0 my-2"><a href="fileupload.jsp">File Upload</a></li>
								<li class="mx-lg-4 mx-md-3 my-md-0 my-2"><a href="filedownload.jsp">File Download</a></li>
							   <li class="mx-lg-4 mx-md-3 my-md-0 my-2"><a href="index.jsp">Logout</a></li>
